				...
				{projects.map(({ title, id, des, link, img, iconLists }) => (
					...
					>
						<PinContainer title={link} href={link} className='border-none'>
							<div className="relative flex items-center justify-center sm:w-96 w-[80vw]  h-[13rem] rounded-2xl overflow-hidden mb-8">
							...
							<div className="flex justify-center items-center">
								<a href={link} target='_blank' className="flex lg:text-base md:text-xs text-sm text-purple">
									Check Live Site
								</a>
