		...
		<div className="py-20">
			...
			<div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-10">
				{projects.map(({ title, id, des, link, img, iconLists }) => (
					<div
						key={id}
						className="lg:min-h-[32rem] h-[35rem] flex items-center justify-center sm:w-96 w-[80vw]  lg:rounded-3xl"
					>
						<PinContainer title={link} href={link}>
							<div className="relative flex items-center justify-center sm:w-96 w-[80vw] lg:h-[16rem]">
