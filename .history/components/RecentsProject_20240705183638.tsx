					...
					>
						<PinContainer title={title} href={link}>
							<div className="relative flex items-center justify-center sm:w-96 w-[80vw] lg:h-[30vh]">
								...
								<img src={img} alt="project-img" className="z-10 absolute bottom-0" />
							</div>
							...
							<div className="flex items-center justify-between mt-7 mb-3">
								<div className="flex items-center">
									{iconLists.map((icon, index) => (
										<div
											key={index}
											className="rounded-full border border-black-10-0 bg-black lg:w-10 lg:h-10 w-8 h-8 flex justify-center items-center"
											style={{
