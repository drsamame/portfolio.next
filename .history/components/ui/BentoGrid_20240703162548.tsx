	...
	return (
		<div
			...
			style={{
				...
				backgroundColor:
					'rgb(2,1,24) linear-gradient(90deg, rgba(2,1,24,1) 0%, rgba(134,134,168,1) 68%, rgba(21,77,88,1) 100%)',
			}}
		>
			<div className={`${id === '6' && 'flex justify-center h-full'}`}>
				<div className="w-full h-full absolute">{img && <img src={img} alt={img} className={cn{imgClassName}} />}</div>
			</div>
